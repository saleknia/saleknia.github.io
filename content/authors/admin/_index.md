...
During my master’s program at [Iran University of Science and Technology (IUST)](https://www.iust.ac.ir/en), I specialized in computer vision under the supervision of [Dr. Ahmad Ayatollahi](https://scholar.google.com/citations?user=KjumZJgAAAAJ&hl=en). I gained hands-on experience in Human Action Recognition and Scene Classification, and conducted experiments on medical image segmentation datasets, including BSUI, TNUI, Synapse, and ISIC (2016–2018). These efforts resulted in several publications (My [Google Scholar](https://scholar.google.ca/citations?hl=en&pli=1&user=MVj813sAAAAJ) profile), with additional manuscripts currently in preparation or revision. Through these projects, I have developed strong expertise in computer vision, image segmentation, knowledge distillation, image classification, and medical image analysis.
