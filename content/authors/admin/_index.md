...
**Amir Hossein Saleknia** is a research assistant at the Computer Vision Center at [Iran University of Science and Technology (IUST)](https://www.iust.ac.ir/en). He earned his master’s degree in Electrical Engineering in 2022, specializing in computer vision under [Prof. Ahmad Ayatollahi](https://scholar.google.com/citations?user=KjumZJgAAAAJ&hl=en). During his studies, Amir gained hands-on experience in Human Action Recognition and Scene Classification and conducted experiments on medical image segmentation datasets. He developed innovative knowledge distillation strategies to achieve both efficiency and accuracy. These efforts have resulted in several publications, with additional manuscripts in preparation or revision. Amir’s long-term research goal is to empower AI agents to explain phenomena beyond the low-level statistics of observable data.
